...
// }
// Lo hace con clase y hastable con function
class LinkedList{
  constructor(){
    this.head = null;
  }
  add(value){
    ...
    if (!current){ //si la lista está vacia
      this.head = nodo;
      return nodo;
    }//si hay nodos, recorremos hasta el ultimo
    while(current.next){
...
HashTable.prototype.set = function(key, value){
  ...
  //si la pos en el arreglo está vacia, crea un obj para guardar los valores
